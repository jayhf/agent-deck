...
func TestGetWorktreeSettings(t *testing.T) {
	...
	if settings.BranchPrefix != "feature/" {
		t.Errorf("GetWorktreeSettings BranchPrefix: got %q, want %q", settings.BranchPrefix, "feature/")
	}
}
...
func TestGetWorktreeSettings_CustomBranchPrefix(t *testing.T) {
	...
	settings := GetWorktreeSettings()
	if settings.BranchPrefix != "fix/" {
		t.Errorf("GetWorktreeSettings BranchPrefix: got %q, want %q", settings.BranchPrefix, "fix/")
	}
}
...
func TestWorktreeSettings_Prefix_Custom(t *testing.T) {
	settings := WorktreeSettings{BranchPrefix: "dev/"}
...
func TestWorktreeSettings_Prefix_Empty(t *testing.T) {
	settings := WorktreeSettings{BranchPrefix: ""}
	if got := settings.Prefix(); got != "feature/" {
		t.Errorf("Prefix() with empty BranchPrefix: got %q, want %q", got, "feature/")
	}
}
